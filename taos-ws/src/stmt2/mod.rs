...
mod tests {
    ...
    #[cfg(feature = "test-new-feat")]
    #[tokio::test(flavor = "multi_thread")]
    async fn test_stmt2_table() -> anyhow::Result<()> {
        use taos_query::common::decimal::Decimal;
        ...
        taos.exec_many([
            "drop database if exists test_1775208541",
            "create database test_1775208541",
            "use test_1775208541",
        ...
        taos.exec("drop database if exists test_1775208541").await?;
    ...
    #[cfg(feature = "test-new-feat")]
    #[tokio::test(flavor = "multi_thread")]
    async fn test_stmt2_stable() -> anyhow::Result<()> {
        use bytes::Bytes;
        use taos_query::common::decimal::Decimal;
        use taos_query::common::{Precision, Timestamp};
        ...
        taos.exec_many([
            "drop database if exists test_1775299262",
            "create database test_1775299262",
            "use test_1775299262",
        ...
        taos.exec("drop database if exists test_1775299262").await?;
    ...
    #[cfg(feature = "test-new-feat")]
    #[tokio::test(flavor = "multi_thread")]
    async fn test_stmt2_tbname() -> anyhow::Result<()> {
        use bytes::Bytes;
        use taos_query::common::decimal::Decimal;
        use taos_query::common::{Precision, Timestamp};
        ...
        taos.exec_many([
            "drop database if exists test_1775299596",
            "create database test_1775299596",
            "use test_1775299596",
            "create table s0 (ts timestamp, c1 bool, c2 tinyint, c3 smallint, c4 int, \
                c5 bigint, c6 tinyint unsigned, c7 smallint unsigned, c8 int unsigned, \
                c9 bigint unsigned, c10 float, c11 double, c12 varchar(20), c13 nchar(20), \
        ...
        taos.exec("drop database if exists test_1775299596").await?;
